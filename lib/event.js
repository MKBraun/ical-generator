...
var ICalEvent = function(_data, calendar) {
    ...
    this.repeating = function(repeating) {
        ...
        if (repeating.bySetPos) {
            if(typeof repeating.bySetPos !== 'number' || repeating.bySetPos < -366 || repeating.bySetPos > 366 || repeating.bySetPos === 0) {
                throw '`repeating.bySetPos` contains invalid value `' + repeating.bySetPos + '`!';
            }

            data.repeating.bySetPos = repeating.bySetPos;
        }
    ...
    this.generate = function(calendar) {
        ...
        if(data.repeating) {
            ...
            if(data.repeating.bySetPos) {
                g += ';BYSETPOS=' + data.repeating.bySetPos;
            }
