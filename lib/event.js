...
var ICalEvent = function(_data, calendar) {
    ...
    this.repeating = function(repeating) {
        ...
        if (repeating.bySetPosition) {
            if(typeof repeating.bySetPosition !== 'number' || repeating.bySetPosition < -366 || repeating.bySetPosition > 366) {
                throw '`repeating.bySetPosition` contains invalid value `' + repeating.bySetPosition + '`!';
            }

            data.repeating.bySetPosition = repeating.bySetPosition;
        }
    ...
    this.generate = function(calendar) {
        ...
        if(data.repeating) {
            ...
            if(data.repeating.bySetPosition) {
                g += ';BYSETPOS=' + data.repeating.bySetPosition;
            }
